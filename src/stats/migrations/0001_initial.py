    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player', models.ForeignKey(to='stats.Player', related_name='+')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gkhr', models.FloatField(default=0)),
                ('wl', models.FloatField(default=0)),
                ('mission', models.ForeignKey(to='stats.Mission', related_name='+')),
                ('player', models.ForeignKey(to='stats.Player', related_name='+')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aircraft', models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.PROTECT, to='stats.Object')),
                ('mission', models.ForeignKey(to='stats.Mission', related_name='sorties_list')),
                ('player', models.ForeignKey(to='stats.Player', related_name='sorties_list')),
                ('profile', models.ForeignKey(to='stats.Profile', related_name='+')),
            ],
            options={
                'db_table': 'sorties',
                'ordering': ['-id'],
        ...
        migrations.AddField(
            model_name='sortie',
            name='tour',
            field=models.ForeignKey(to='stats.Tour', related_name='sorties'),
        ),
        migrations.AddField(
            model_name='playermission',
            name='profile',
            field=models.ForeignKey(to='stats.Profile', related_name='+'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='player',
            name='tour',
            field=models.ForeignKey(to='stats.Tour', related_name='+'),
        ),
        migrations.AddField(
            model_name='object',
            name='score',
            field=models.ForeignKey(to='stats.Score'),
        ),
        migrations.AddField(
            model_name='mission',
            name='tour',
            field=models.ForeignKey(to='stats.Tour', related_name='missions'),
        ),
        migrations.AddField(
            model_name='logentry',
            name='act_object',
            field=models.ForeignKey(related_name='+', null=True, to='stats.Object', blank=True),
        ),
        migrations.AddField(
            model_name='logentry',
            name='act_sortie',
            field=models.ForeignKey(related_name='+', null=True, to='stats.Sortie', blank=True),
        ),
        migrations.AddField(
            model_name='logentry',
            name='cact_object',
        ...
        migrations.AddField(
            model_name='logentry',
            name='mission',
            field=models.ForeignKey(to='stats.Mission', related_name='+'),
        ),
        migrations.AddField(
            model_name='killboardpvp',
            name='player_1',
            field=models.ForeignKey(to='stats.Player', related_name='+'),
        ),
        migrations.AddField(
            model_name='killboardpvp',
            name='player_2',
