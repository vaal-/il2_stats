    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score_bomber', models.IntegerField(db_index=True, default=0)),
                ('score_attacker', models.IntegerField(db_index=True, default=0)),
                ('score_fighter', models.IntegerField(db_index=True, default=0)),
                ('rating', models.IntegerField(db_index=True, default=0)),
                ('rating_bomber', models.IntegerField(db_index=True, default=0)),
                ('rating_attacker', models.IntegerField(db_index=True, default=0)),
                ('rating_fighter', models.IntegerField(db_index=True, default=0)),
